...
import { View, ScrollView, BackHandler, ListView, Platform,NetInfo, FlatList, Text, AsyncStorage, Image, TouchableOpacity } from 'react-native';
        ...
        this.getCache((value) => {
            if (value !== null) {
                ...
                Axios({
                    ...
                    url: Config.routes.base + Config.routes.receiptsList
                })
                    .then((response) => {
        ...
        return (
            ...
            <View style={CustomStyles.viewStyle}>
                            ...
                            <View style={[CustomStyles.erpCategoryCardItems, { backgroundColor: !this.state.categoryBgColor ? '#ffffff' : '#f6f6f6' }]}>
                                <View style={CustomStyles.erpDriverItems}>
                                    ...
                                    <View style={[CustomStyles.erpTextView, { flex: 0.2, alignItems: 'flex-end', borderBottomWidth: 0, paddingBottom: 5 }]}>
                                        <TouchableOpacity onPress={() => { this.props.navigation.navigate('AddReceipts', { token: this.state.token, id: item._id, edit: true, refresh: this.refreshFunction }) }}>
                                            <Image resizeMode="contain"
                ...
                <View style={CustomStyles.addGroupImageStyle}>
                    <TouchableOpacity
                        onPress={() => { this.props.navigation.navigate('AddReceipts', { token: this.state.token, edit: false, refresh: this.refreshFunction }) }}
                    >
                        <Image source={require('../images/eg_receipt.png')}
